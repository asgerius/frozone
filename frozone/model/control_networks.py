...
class ResNext(_ControlNetwork):
    ...
    def __init__(self, config: FzConfig):
        ...
        self.layers = nn.Sequential(*self.build_resnext(in_size, self.config.Du))
